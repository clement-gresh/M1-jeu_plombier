    ...
    public boolean majCouleurs(){
        ...
        for(int l = 0; l < this.hauteur; l++) {
            for(int c = 0; c < this.largeur; c++) {
                ...
                if(tuyau != null) {
                    for(int i = 0; i < tuyau.getDejaVisite().size(); i++){
                        tuyau.setDejaVisite(i, false);
